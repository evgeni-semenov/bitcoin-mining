...
The process is of course oversimplified, but you will get a general idea. Normally each bitcoin block includes:
...
Miners form the blocks and try different nonce values to solve the hash puzzle = 
